              ...
              <Row>
                ...
                <Row>
                  <h2 className="text-center text-success my-3">
                    <i className="bi bi-check2-circle d-md-none"></i> Thank you
                    for your order
                  </h2>
                </Row>
              </Row>
              ...
              <Row>
                ...
                <Row>
                  <h2 className="text-center text-danger my-3">
                    <i class="bi bi-x-circle d-md-none text-danger"></i> Payment Failed
                  </h2>
                </Row>
              </Row>
            )}
                ...
                <Card.Body>
                  {order.shipping_address ? (
                    ...
                    <Row>
                      ...
                      <p>
                        It may take a few minutes for your patterns to arrive in
                        your email.
                      </p>
                    </Row>
                  )}
